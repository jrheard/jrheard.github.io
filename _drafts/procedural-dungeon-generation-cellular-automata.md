...
The basic idea with cellular automata is that you're mimicking the patterns of bacteria in a petri dish (sort of, if you squint a little); we'll be simulating the passage of time, during which cells are born and die.[^1]
...
I didn't pop out of the womb with a well-developed intuition re: how birth and survival thresholds affect the shape of caves generated by cellular automata, and so I had some trouble figuring out how to proceed when I got to this point. Like last time, building a little tool helped a lot.
...
After playing around with the different options available, I've come to like using an initial chance of 0.45, a survival threshold of 4, and a birth threshold of 5. This set of parameters seems to reliably generate the specific kind of open cave areas that I'm interested in. Let's give our implementation of the algorithm another shot:
